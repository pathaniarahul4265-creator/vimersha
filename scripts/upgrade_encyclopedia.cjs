/**
 * Script to create and inject the Classical Vedic Astrology Encyclopedia & Knowledge Base
 */
const fs = require('fs');
...
// Define the comprehensive glossary database with categories, historical background, logic, and how-it-works explanations
const glossaryDataScript = `
<script id="vedicGlossaryDataScript">
window.VEDIC_GLOSSARY_DATABASE = [
  ...
  },
  {
    ...
    detailedHtml: \`
      <div class="glossary-deep-dive">
        ...
        <div class="glossary-section-block">
          <div class="glossary-subhead">⚖️ Historical Evolution</div>
          <p class="glossary-justified-text">
      ...
      <div class="glossary-deep-dive">
        ...
        <div class="glossary-section-block">
          ...
          <p class="glossary-justified-text">
            ...
            <strong>Dridha Karma (दृढ़ - Fixed):</strong> Formed by intense, deliberate past actions; manifests inevitably and must be endured with patience and wisdom.
            <strong>Dridha-Adridha Karma (दृढ़-अदृढ़ - Mixed):</strong> Manifests as moderate obstacles that can be mitigated or altered through dedicated spiritual disciplines, mantras, and remedies.
            <strong>Adridha Karma (अदृढ़ - Malleable):</strong> Readily influenced, corrected, and dissolved through present effort (Purushartha), righteous choices, and conscious awareness.
          </p>
        </div>
        <div class="glossary-section-block">
      ...
      <div class="glossary-deep-dive">
        ...
        <div class="glossary-section-block">
          ...
          <p class="glossary-justified-text">
            ...
            <br/>
            <strong>Trikonas (1, 5, 9):</strong> The Temples of Lakshmi representing divine grace, luck, and wisdom.
            <br/>
            <strong>Upachayas (3, 6, 10, 11):</strong> Houses of continuous growth where malefic planets perform brilliantly by overcoming challenges over time.
            <br/>
            <strong>Dusthanas (6, 8, 12):</strong> Houses of suffering, purification, and karmic refinement.
            <br/>
            <strong>Marakas (2, 7):</strong> Houses of life-transitions and exit indicators.
          </p>
        </div>
      </div>
    \`
  ...
  },
  {
    ...
    detailedHtml: \`
      <div class="glossary-deep-dive">
        <div class="glossary-section-block">
          <div class="glossary-subhead">📜 The Science of Electional Astrology</div>
          <p class="glossary-justified-text">
            <strong>Muhurta</strong> is the Vedic science of timing the initiation of any significant worldly endeavor—such as marriage (<em>Vivaha</em>), housewarming (<em>Griha Pravesha</em>), business launch (<em>Vyapar Arambha</em>), or surgical medical procedures—so that the celestial energies support the endeavor.
          </p>
        </div>
        <div class="glossary-section-block">
          <div class="glossary-subhead">⚙️ Planetary Horas &amp; 8-Part Choghadiya Cycles</div>
          <p class="glossary-justified-text">
            <strong>Planetary Hora:</strong> Each day (from local sunrise to the next sunrise) is divided into 24 planetary hours governed by the ancient Chaldean speed sequence (Saturn &rarr; Jupiter &rarr; Mars &rarr; Sun &rarr; Venus &rarr; Mercury &rarr; Moon).
            <br/><br/>
            <strong>Choghadiya:</strong> The daytime and nighttime are each partitioned into 8 equal segments (approximately 1.5 hours each) assigned to specific planetary influences: <em>Amrit</em> (Nectar/Moon), <em>Shubh</em> (Auspicious/Jupiter), <em>Labh</em> (Gain/Mercury), <em>Char</em> (Movable/Venus), <em>Rog</em> (Disease/Mars), <em>Kaal</em> (Loss/Saturn), and <em>Udveg</em> (Agitation/Sun).
            <br/><br/>
            <strong>Abhijit Muhurta:</strong> The 8th Muhurta of the day (centered precisely on solar noon), celebrated as a universal dispeller of minor doshas blessed by Lord Vishnu.
          </p>
        </div>
      </div>
    \`
...
// Replace the Glossary Modal HTML in index.html with the new rich Encyclopedia Modal
const glossaryModalRegex = /<!-- Vedic Terms Glossary Modal -->[\s\S]*?<\/div>\s*<\/div>\s*<\/div>/;
const glossaryModalReplacement = `<!-- Classical Vedic Astrology Encyclopedia & Glossary Modal -->
<div class="modal-overlay" id="glossaryModal" onclick="if(event.target===this) closeGlossaryModal();">
  <div class="modal-box" style="max-width:920px;max-height:88vh;overflow-y:auto;background:#0b1120;border:1.5px solid rgba(216,160,76,0.45);border-radius:18px;padding:26px;box-shadow:0 25px 80px rgba(0,0,0,0.92);color:#e2e8f0;">
    <button type="button" class="modal-close" onclick="closeGlossaryModal()" aria-label="Close">&times;</button>
    
    <!-- Header Banner -->
    <div style="display:flex;align-items:center;gap:14px;margin-bottom:18px;border-bottom:1px solid rgba(216,160,76,0.3);padding-bottom:14px;flex-wrap:wrap;">
      <div style="width:48px;height:48px;border-radius:50%;overflow:hidden;border:1.5px solid #d8a04c;box-shadow:0 0 15px rgba(216,160,76,0.4);background:#060a17;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
        <img src="/images/jyotish_vimarsha_logo.png" onerror="this.src='/images/celestial_zodiac_mandala.svg'" alt="Sacred Vedic Logo" style="width:100%;height:100%;object-fit:cover;" />
      </div>
      <div style="flex:1;">
        <h2 style="margin:0;font-family:'Cinzel',serif;font-size:22px;color:#fce8bd;letter-spacing:0.04em;">Classical Vedic Astrology Glossary &amp; Shastra</h2>
        <div style="font-size:12.5px;color:#7fc5c0;margin-top:2px;">The Complete Encyclopedia of Vedanga Jyotisha: History, Philosophical Logic, Cosmic Mechanics &amp; Astrometry.</div>
      </div>
    </div>
    ...
    <div style="display:flex;flex-direction:column;gap:12px;margin-bottom:18px;">
      <div style="position:relative;">
        <input type="text" id="glossarySearchInput" oninput="filterGlossaryEncyclopedia()" placeholder="🔍 Search concepts, Sanskrit terms, texts, or mechanics (e.g. Parashara, Dasha, Karma, Shodashavarga, Sade Sati, Lagna)..." style="width:100%;padding:11px 16px;background:rgba(0,0,0,0.55);border:1px solid rgba(216,160,76,0.4);border-radius:10px;color:#fce8bd;font-size:13.5px;outline:none;box-sizing:border-box;box-shadow:inset 0 2px 6px rgba(0,0,0,0.4);" />
      </div>

      <!-- Category Tabs -->
      <div class="glossary-category-pills" id="glossaryCategoryPills" style="display:flex;flex-wrap:wrap;gap:7px;">
        <button type="button" class="glossary-cat-btn active" data-cat="all" onclick="selectGlossaryCategory('all')">✦ All Knowledge (50+ Concepts)</button>
    ...
    <!-- Active Count / Status -->
    <div id="glossaryStatusLine" style="font-size:11.5px;color:#94a3b8;margin-bottom:14px;display:flex;align-items:center;justify-content:space-between;">
      <span id="glossaryCountText">Displaying all foundational treatises and principles</span>
      <span style="color:#dfba6d;font-family:'Cinzel',serif;">वेदस्य चक्षुः किल शास्त्रमेतत्</span>
    </div>

    <!-- Glossary Cards Container -->
    <div class="glossary-encyclopedia-container" id="glossaryEncyclopediaContainer" style="display:flex;flex-direction:column;gap:14px;">
      <!-- Populated dynamically via JS from VEDIC_GLOSSARY_DATABASE -->
    </div>
  </div>
</div>`;

content = content.replace(glossaryModalRegex, glossaryModalReplacement);

// Add the database script right above closing </body> or before </script>
if (!content.includes('VEDIC_GLOSSARY_DATABASE')) {
  content = content.replace('</body>', `${glossaryDataScript}\n</body>`);
}

// Add CSS styling for the Encyclopedia Modal and Justified Typography
const glossaryStyles = `
/* Classical Vedic Astrology Encyclopedia & Justified Typography Styles */
.glossary-cat-btn {
  background: rgba(255, 255, 255, 0.04);
  border: 1px solid rgba(216, 160, 76, 0.25);
  border-radius: 999px;
  color: #cbd5e1;
...
.glossary-cat-btn:hover {
  background: rgba(216, 160, 76, 0.15);
  border-color: rgba(216, 160, 76, 0.5);
  color: #fce8bd;
}

.glossary-cat-btn.active {
  background: linear-gradient(135deg, rgba(216, 160, 76, 0.28), rgba(216, 160, 76, 0.12));
  border-color: #d8a04c;
  color: #ffffff;
  box-shadow: 0 0 10px rgba(216, 160, 76, 0.25);
}

.glossary-card-item {
  background: linear-gradient(145deg, rgba(17, 26, 46, 0.85), rgba(9, 14, 28, 0.95));
  border: 1px solid rgba(216, 160, 76, 0.25);
  border-radius: 12px;
  padding: 18px 20px;
...
.glossary-card-item:hover {
  border-color: rgba(216, 160, 76, 0.55);
  box-shadow: 0 8px 25px rgba(0, 0, 0, 0.5), 0 0 15px rgba(216, 160, 76, 0.15);
}
...
.glossary-section-block {
  ...
  border: 1px solid rgba(216, 160, 76, 0.15);
  border-radius: 8px;
  padding: 12px 14px;
}
...
.glossary-justified-text strong {
  color: #fce8bd !important;
}

.glossary-justified-text em {
  color: #7fc5c0 !important;
  font-style: italic !important;
}
`;

if (!content.includes('.glossary-encyclopedia-container')) {
  content = content.replace('</style>', `${glossaryStyles}\n</style>`);
}

// Update the JavaScript handlers for the new Encyclopedia
const glossaryJsHandlers = `
...
window.renderGlossaryEncyclopedia = function() {
  ...
  const cat = window.currentGlossaryCategory;
  ...
  if (filtered.length === 0) {
    container.innerHTML = \`
      <div style="text-align:center;padding:40px 20px;color:#94a3b8;">
        ...
        <div style="font-size:15px;color:#fce8bd;font-family:'Cinzel',serif;">No matching classical concept found</div>
        <div style="font-size:12px;margin-top:4px;">Try searching for terms like <em>Parashara, Dasha, Karma, Lagna, Sade Sati, or Nakshatra</em></div>
      </div>
    \`;
    return;
  }
  ...
  container.innerHTML = filtered.map(item => \`
    <div class="glossary-card-item" id="glossary_item_\${item.id}">
      <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:12px;flex-wrap:wrap;border-bottom:1px solid rgba(216,160,76,0.18);padding-bottom:10px;">
        <div>
          <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
            <h3 style="margin:0;font-family:'Cinzel',serif;font-size:16.5px;color:#fce8bd;letter-spacing:0.02em;">\${item.title}</h3>
            <span style="font-size:10.5px;background:rgba(216,160,76,0.15);border:1px solid rgba(216,160,76,0.35);color:#dfba6d;padding:2px 8px;border-radius:999px;font-family:'Manrope',sans-serif;">\${item.categoryLabel}</span>
          </div>
          \${item.sanskrit ? \`<div style="font-family:'Bodoni Moda',serif;font-size:12px;color:#7fc5c0;font-style:italic;margin-top:3px;">\${item.sanskrit}</div>\` : ""}
        </div>
      </div>
      <p style="font-size:12.5px;color:#e2e8f0;margin:10px 0;text-align:justify;text-justify:inter-word;line-height:1.6;">\${item.shortDesc}</p>
      \${item.detailedHtml}
    </div>
  \`).join("");
};
...
// Hook into openGlossaryModal
const origOpenGlossary = window.openGlossaryModal;
...
content = content.replace('window.openGlossaryModal = function() {', `${glossaryJsHandlers}\n// original openGlossary replaced\nwindow.oldOpenGlossaryModal = function() {`);

fs.writeFileSync(indexHtmlPath, content);
console.log('✓ Successfully upgraded Classical Vedic Astrology Encyclopedia & Glossary in index.html!');
