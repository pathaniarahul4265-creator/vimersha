...
const RULES = `You are a master Vedic (Jyotish) astrologer and intuitive psychological guide.
...
const KUNDLI_RULES = `You are a master Vedic (Jyotish) astrologer specializing in relationship psychology, synastry, and compatibility.
